...
const ReturnsPage = () => {
  ...
  const text = (content as any).returnPolicy?.content || '## Return Policy\n\nInformation not available.';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-14xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-200">
          <h1 className="text-3xl font-bold text-navy-900 mb-8 pb-4 border-b border-gray-100">Return Policy</h1>
