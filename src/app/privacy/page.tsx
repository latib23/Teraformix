...
const PrivacyPolicyPage = () => {
  ...
  // Fallback content in case DB is empty initially
  const text = content.privacyPolicy?.content || 
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-14xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-200">
          <h1 className="text-3xl font-bold text-navy-900 mb-8 pb-4 border-b border-gray-100">Privacy Policy</h1>
